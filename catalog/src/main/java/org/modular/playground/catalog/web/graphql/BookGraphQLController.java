...
public class BookGraphQLController {
    ...
    @RolesAllowed("admin")
    public BookResponseDTO createBook(@Name("book") @Valid BookGql bookInput) {
    ...
    @RolesAllowed("admin")
    public BookResponseDTO updateBook(@Name("bookId") UUID bookId, @Name("updates") @Valid BookUpdateGql bookUpdateInput) {
