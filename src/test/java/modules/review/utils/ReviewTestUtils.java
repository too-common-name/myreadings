...
public class ReviewTestUtils {
    ...
    private static ReviewImpl.ReviewImplBuilder createBaseReviewBuilder(String reviewText) {
    ...
    public static ReviewImpl createValidReviewWithIdAndText(UUID reviewId, String reviewText) {
        return createBaseReviewBuilder(reviewText)
                .reviewId(reviewId)
                .build();
    }
    ...
    public static ReviewImpl createValidReviewForUserAndBook(UUID userId, UUID bookId, String reviewText, int rating) {
        return ReviewImpl.builder()
                .reviewId(UUID.randomUUID())
                .book(CatalogTestUtils.createValidBookWithId(bookId))
                .user(UserTestUtils.createValidUserWithId(userId))
                .reviewText(reviewText)
                .rating(rating)
                .publicationDate(LocalDateTime.now())
                .build();
